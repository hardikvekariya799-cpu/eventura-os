    ...
    <div style={S.app}>
      <aside style={S.sidebar}>
        ...
        <div style={S.sidebarFooter}>
          ...
          <div style={S.smallNote}>Finance restored (placeholder) to unblock deployment.</div>
        </div>
      </aside>
      ...
      <main style={S.main}>
        <div style={S.header}>
          <div>
            <div style={S.h1}>Finance (Temporarily Restored)</div>
            <div style={S.muted}>Your full automated finance page will be re-added after deploy is stable.</div>
          </div>
        </div>
        ...
        <section style={S.panel}>
          ...
          <div style={S.smallNote}>
            Deployment fix in progress. Once build passes, we will paste back your full finance code safely.
          </div>
        </section>
      </main>
    </div>

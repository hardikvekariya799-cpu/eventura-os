    ...
    <div style={S.app}>
      <aside style={S.sidebar}>
        ...
        <nav style={S.nav}>
          ...
          <Link href="/ai" style={S.navActive as any}>🤖 AI</Link>
        ...
        <div style={S.sidebarFooter}>
          ...
          <div style={S.smallNote}>Status: <b>Stable placeholder</b></div>
        </div>
      </aside>
      ...
      <main style={S.main}>
        <div style={S.header}>
          <div>
            <div style={S.h1}>AI (Stable)</div>
            <div style={S.muted}>This page is restored to prevent deployment failure.</div>
          </div>
        </div>

        <section style={S.panel}>
          <div style={S.panelTitle}>Next Step</div>
          <div style={S.smallNote}>
            We’ll rebuild AI features after your deployment is stable.
          </div>
        </section>
      </main>
    </div>

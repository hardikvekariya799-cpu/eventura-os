      ...
      <main style={S.main}>
        <div style={S.header}>
          <div>
            ...
            <div style={S.muted}>Your app is rebuilding. Next we’ll restore other pages if needed.</div>
          </div>
        </div>
        ...
        <section style={S.panel}>
          ...
          <div style={S.grid}>
            <QuickCard title="Events" href="/events" S={S} />
            <QuickCard title="Finance" href="/finance" S={S} />
            <QuickCard title="Notes" href="/notes" S={S} />
            <QuickCard title="Reports" href="/reports" S={S} />
          </div>
        </section>
      </main>
    </div>
...
function QuickCard({ title, href, S }: { title: string; href: string; S: any }) {
  return (
    <Link href={href} style={S.card as any}>
      <div style={S.cardTitle}>{title}</div>
      <div style={S.cardSub}>Open</div>
    </Link>
  );
}

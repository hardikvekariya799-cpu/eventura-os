    ...
    <div style={S.app}>
      <aside style={S.sidebar}>
        ...
        <nav style={S.nav}>
          ...
          <Link href="/reports" style={S.navActive as any}>📈 Reports</Link>
        ...
        <div style={S.sidebarFooter}>
          ...
          <div style={S.smallNote}>Reports restored (placeholder) to unblock deployment.</div>
        </div>
      </aside>
      ...
      <main style={S.main}>
        <div style={S.header}>
          <div>
            <div style={S.h1}>Reports (Temporarily Restored)</div>
            <div style={S.muted}>Once deployment is stable, we will restore your advanced reports.</div>
          </div>
        </div>
        ...
        <section style={S.panel}>
          ...
          <div style={S.smallNote}>
            Build recovery in progress. We’re fixing pages that were overwritten.
          </div>
        </section>
      </main>
    </div>
